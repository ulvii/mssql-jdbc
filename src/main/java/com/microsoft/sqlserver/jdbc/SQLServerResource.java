...
public final class SQLServerResource extends ListResourceBundle {
    ...
    static final Object[][] CONTENTS = {
            ...
            {"R_sslProtocolPropertyDescription",
                    "SSL protocol label from TLS, TLSv1, TLSv1.1, TLSv1.2, and TLSv1.3. The default is TLS."},
            {"R_invalidSSLProtocol",
                    "SSL Protocol {0} label is not valid. Only TLS, TLSv1, TLSv1.1, TLSv1.2, and TLSv1.3 are supported."},

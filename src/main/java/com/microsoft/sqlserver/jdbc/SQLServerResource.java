...
public final class SQLServerResource extends ListResourceBundle {
    ...
    static final Object[][] contents = {
            ...
            {"R_insufficientRetryWindow", "Connection retry window is larger than query timeout. Please adjust parameters so that ConnectionRetryCount * (ConnectionRetryDelay + LoginTimeout) is less than Query Timeout."},};
}

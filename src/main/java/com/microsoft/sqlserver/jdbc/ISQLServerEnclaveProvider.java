...
public interface ISQLServerEnclaveProvider {
    ...
    /**
     * Stored procedure call for Always Encrypted.
     */
    static final String SDPE1 = "EXEC sp_describe_parameter_encryption ?,?";

    /**
     * Stored procedure call for Always Encrypted with secure enclaves.
     */
    static final String SDPE2 = "EXEC sp_describe_parameter_encryption ?,?,?";

    /**
     * Constructs and return enclave package.
     * 
     * @param userSQL
     *        SQL query from user.
     * @param enclaveCEKs
     *        Enclave Column Encryption Keys.
     * @return Enclave package.
    ...
    /**
     * Executes stored procedure for Always Encrypted with secure enclaves.
     * 
     * @param stmt
     ...
     *        PreparedStatement type definitions.
     * @param req
    ...
    /**
     * Executes stored procedure for Always Encrypted.
     * 
     * @param stmt
     *        PreparedStatement to execute the query.
     * @param userSql
    ...
    /**
     * Processed the ResultSet for Alway encrypted.
     * 
     * @param userSql
     *        SQL query from user.
     * @param preparedTypeDefinitions
     ...
     * @param rs
     *        ResultSet generated by stored procedure call.
     * @param enclaveRequestedCEKs
     *        Column Encryption Keys requested by Enclave.
     * @throws SQLException
     *         when error occurs.
     */

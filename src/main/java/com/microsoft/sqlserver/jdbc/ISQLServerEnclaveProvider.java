...
public interface ISQLServerEnclaveProvider {
    ...
    /**
     * Contrusts and returns enclave package.
     * 
     * @param userSQL
     *        User SQL.
     * @param enclaveCEKs
    ...
    /**
     * Executed stored procedure for Always Encrypted.
     *
     * @param stmt
     ...
     * @param preparedTypeDefinitions
     *        Type definitions.
     * @return Result set generated by procedure call.
     * @throws SQLException
     *         if error occurs.
     */
    ...
    /**
     * Process result set for Always Encrypted.
     * 
     * @param userSql
     *        User SQL.
     * @param preparedTypeDefinitions
